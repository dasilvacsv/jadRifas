...
// Componente para los botones de acción con estado de carga
function SubmitButton({ children, newStatus }: { children: React.ReactNode; newStatus: "confirmed" | "rejected" }) {
          ...
          {purchase.status === 'pending' ? (
            <>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>¿Estás seguro de rechazar esta compra?</AlertDialogTitle>
                    <AlertDialogDescription>
                      Esta acción no se puede deshacer. Los tickets no serán asignados al comprador.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    ...
                    <form action={formAction} className="w-full sm:w-auto">
                      ...
                      <AlertDialogAction asChild>
                        <SubmitButton newStatus="rejected">Sí, rechazar</SubmitButton>
                      </AlertDialogAction>
                    </form>
                  </AlertDialogFooter>
                </AlertDialogContent>
